...
List flashpca_plink_internal(std::string fn, Eigen::Map<Eigen::MatrixXd> X, int stand, unsigned int ndim, unsigned int maxiter, unsigned int block_size, double tol, long seed, bool verbose, bool do_loadings, bool return_scale);
RcppExport SEXP flashpcaR_flashpca_plink_internal(SEXP fnSEXP, SEXP XSEXP, SEXP standSEXP, SEXP ndimSEXP, SEXP maxiterSEXP, SEXP block_sizeSEXP, SEXP tolSEXP, SEXP seedSEXP, SEXP verboseSEXP, SEXP do_loadingsSEXP, SEXP return_scaleSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< bool >::type do_loadings(do_loadingsSEXP);
    Rcpp::traits::input_parameter< bool >::type return_scale(return_scaleSEXP);
    rcpp_result_gen = Rcpp::wrap(flashpca_plink_internal(fn, X, stand, ndim, maxiter, block_size, tol, seed, verbose, do_loadings, return_scale));
    return rcpp_result_gen;
END_RCPP
}
// scca_internal
