...
flashpca_internal <- function(X, stand, ndim, divisor, maxiter, tol, seed, verbose, do_loadings, return_scale) {
    .Call('_flashpcaR_flashpca_internal', PACKAGE = 'flashpcaR', X, stand, ndim, divisor, maxiter, tol, seed, verbose, do_loadings, return_scale)
}
...
ucca_internal <- function(X, Y, stand_x, stand_y, verbose) {
    .Call('_flashpcaR_ucca_internal', PACKAGE = 'flashpcaR', X, Y, stand_x, stand_y, verbose)
}

standardise_impute <- function(XX, method) {
    .Call('_flashpcaR_standardise_impute', PACKAGE = 'flashpcaR', XX, method)
}

check_internal <- function(X, stand, evec, eval, divisor, verbose) {
    .Call('_flashpcaR_check_internal', PACKAGE = 'flashpcaR', X, stand, evec, eval, divisor, verbose)
}

check_plink_internal <- function(fn, stand, evec, eval, block_size, divisor, verbose) {
    .Call('_flashpcaR_check_plink_internal', PACKAGE = 'flashpcaR', fn, stand, evec, eval, block_size, divisor, verbose)
}

project_plink_internal <- function(fn, loadings, ref_alleles, orig_mean, orig_sd, block_size, divisor, verbose) {
    .Call('_flashpcaR_project_plink_internal', PACKAGE = 'flashpcaR', fn, loadings, ref_alleles, orig_mean, orig_sd, block_size, divisor, verbose)
}
