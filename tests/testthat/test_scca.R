...
test_that(paste0("Testing self-self SCCA (X with X), l1=", l1, ", l2=", l2), {
   ...
   s1 <- scca(X, X,
      lambda1 = l1, lambda2 = l2, ndim = ndim,
...
test_that(paste0(
   "Testing self-self SCCA (X with X), l1=", l1, ", l2=", l2,
   "(no dividing by n)"
), {
...
test_that("Testing self-self SCCA (X with X), initialising V0", {
   ...
   Vx <- matrix(stats::rnorm(m * ndim), m, ndim)
...
test_that("Testing SCCA (X with Y), initialising V0", {
   ...
   V0 <- matrix(stats::rnorm(k * ndim), k, ndim)
...
test_that("Testing input checking", {
   ...
   Z <- matrix(stats::rnorm((nrow(X) + 3) * 100), nrow(X) + 3, 100)
   expect_error(scca(X, Z,
      lambda1 = l1, lambda2 = l2, ndim = ndim,
      standx = "none", standy = "none"
   ))
   expect_error(scca(bedf, Z,
      lambda1 = l1, lambda2 = l2, ndim = ndim,
      standx = "binom2", standy = "none"
   ))
   ...
   expect_error(scca(X, Z,
      lambda1 = l1, lambda2 = -1, ndim = ndim,
      standx = "none", standy = "none"
   ))
   expect_error(scca(X, Z,
      lambda1 = -1, lambda2 = l2, ndim = ndim,
      standx = "none", standy = "none"
   ))
   expect_error(scca(bedf, Z,
      lambda1 = -1, lambda2 = -1, ndim = ndim,
      standx = "binom2", standy = "none"
   ))
})
